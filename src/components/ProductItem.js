...
class ProductItem extends Component{
    ...
    render(){
        ...
        const productItem = product ? (
            <Link to={product.id} className={`product-item ${product.inStock ? "" : " out-of-stock"}`}>
                ...
                <div className="description">
                    ...
                    <span className="f-medium f-18 price">{this.getPrice().currency.label} {this.getPrice().amount}</span>
                </div>
            </Link>
        ) : '';
